...
comment on column events.id is 'Идентификатор пользователя';
comment on column events.name is 'Имя пользователя';
comment on column events.email is 'Электронная почта пользователя';
-- {
